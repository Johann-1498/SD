...
public class PeerHandle {
    ...
    public void sendText(final String targetPeerName, final String text) {
        peerEventLoopGroup.execute(() -> peer.sendText(targetPeerName, text));
    }

    public void sendFile(final String targetPeerName, final String filePath) {
        peerEventLoopGroup.execute(() -> peer.sendFile(targetPeerName, filePath));
    }
