...
public class Main {
    ...
    private static OptionSet parseArguments(final String[] args) throws IOException {
        ...
        optionParser.accepts(CONFIG_FILE_PARAMETER).withOptionalArg().ofType(File.class)
                .describedAs("config properties file");
    ...
    private static void printHelp(final String line) {
        ...
        System.out.println(
                "# 6) send peerName text  >>> Sends a text message to the given peer                                   #");
        System.out.println(
                "# 7) sendfile peer path  >>> Sends a file to the given peer                                           #");
        System.out.println(
                "#######################################################################################################");
    }
